...
public class ShareRuleUtil {
     ...
     * @return Predicate
     */
    public static <T> Predicate handleShareRulePredicate(@NotNull CriteriaBuilder criteriaBuilder, @NotNull Root<T> root, @NotNull ShareRulesDTO shareRules) {
            ...
            for (char c : orderStr.toCharArray()) {
                switch (c) {
                    ...
                    case 'o':
                        ...
                        break;
                    default:
                        ConditionDTO cond = shareRules.getConditions().get(Integer.parseInt(String.valueOf(c)) - 1);
     ...
     * @return
     */
    public static <T> Predicate handleCondition(CriteriaBuilder criteriaBuilder, Root<T> root, ConditionDTO cond) {
    ...
    private static Predicate takeInCriteriaBuilder(ConditionDTO cond, CriteriaBuilder.In<Object> in, CriteriaBuilder criteriaBuilder) {
        ...
        try {
            switch (dataType) {
                ...
                case "decimal":
                    ...
                    break;
                case "date":
                    object = DateTimeUtil.stringToDateTime(value);
                    break;
                case "boolean":
