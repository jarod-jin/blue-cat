...
public class TimeDiffAop {
     ...
     * 在方法前打印开始时间
     */
    @Before("@annotation(cn.jarod.bluecat.core.log.annotation.TimeDiff)")
     ...
     * @return
     */
    @Around("@annotation(cn.jarod.bluecat.core.log.annotation.TimeDiff)")
     ...
     * 在方法后打印总耗时
     */
    @After("@annotation(cn.jarod.bluecat.core.log.annotation.TimeDiff)")
