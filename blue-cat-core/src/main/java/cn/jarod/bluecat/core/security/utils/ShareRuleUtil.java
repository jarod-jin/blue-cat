...
public class ShareRuleUtil {
     ...
     * @return Predicate
     */
    public static <T> Predicate handleShareRulePredicate(@NotNull CriteriaBuilder criteriaBuilder, @NotNull Root<T> root, @NotNull DataShareRuleDO shareRules) {
            ...
            for (char c : orderStr.toCharArray()) {
                switch (c) {
                    ...
                    case 'o':
                        ...
                        break;
                    default:
                        DataConditionDO cond = shareRules.getConditions().get(Integer.parseInt(String.valueOf(c)) - 1);
     ...
     * @return
     */
    public static <T> Predicate handleCondition(CriteriaBuilder criteriaBuilder, Root<T> root, DataConditionDO cond) {
    ...
    private static Predicate takeInCriteriaBuilder(DataConditionDO cond, CriteriaBuilder.In<Object> in, CriteriaBuilder criteriaBuilder) {
